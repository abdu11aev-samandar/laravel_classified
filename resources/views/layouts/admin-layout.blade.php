...
<div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
    <div @click.away="open = false"
        ...
        <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
            <a href="#"
               class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Classified
                Admin</a>
        ...
        <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
            ...
            <x-app-link href="{{ route('admin.childcategories.index') }}"
                        :active="request()->routeIs('admin.childcategories.index')">Child Categories
            </x-app-link>
            <x-app-link href="{{ route('admin.countries.index') }}" :active="request()->routeIs('admin.countries.index')">
                Countries
            </x-app-link>
            <x-app-link href="{{ route('admin.states.index') }}" :active="request()->routeIs('admin.states.index')">States
            </x-app-link>
            <x-app-link href="{{ route('admin.cities.index') }}" :active="request()->routeIs('admin.cities.index')">Cities
            </x-app-link>
